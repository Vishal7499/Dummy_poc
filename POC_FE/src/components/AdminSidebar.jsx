...
const AdminSidebar = ({ isMobileOpen, setIsMobileOpen, isCollapsed, setIsCollapsed }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      active: location.pathname === '/admin/activity-summary'
    },
    {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className="bg-gradient-to-b from-white to-gray-50 border-r border-gray-200 h-screen flex flex-col w-full">
        {/* Header with Toggle */}
