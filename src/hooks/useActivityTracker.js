...
import { getSystemSettings, trackSectionVisit as trackSectionVisitApi } from '../utils/dummyData';
...
export const useActivityTracker = (apiBaseUrl, authToken) => {
  ...
  const trackSectionVisit = useCallback(async (sectionName, sectionBackendName = null, sectionId = null, timeSpent = 0) => {
    ...
    try {
      await trackSectionVisitApi(authToken, sectionName, sectionBackendName, sectionId, timeSpent);
    } catch (error) {
